    ...
    <div className="min-h-screen bg-white flex items-center justify-center px-6">
      <div className="max-w-lg w-full text-center">
        ...
        <div className="space-y-4">
          <Link
            href="/store/book1"
            className="block w-full py-4 bg-black text-white font-semibold border-2 border-black hover:bg-white hover:text-black transition-colors duration-300 text-center"
          >
            Try Again
          </Link>
          <Link
            href="/store"
            className="block text-black hover:underline text-sm"
          >
            ← Back to Store
          </Link>
        </div>
